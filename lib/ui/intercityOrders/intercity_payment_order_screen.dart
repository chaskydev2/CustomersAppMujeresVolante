                                                      ...
                                                      if (snapshot.hasError) {
                                                        ...
                                                        return Container(
                                                          decoration: BoxDecoration(
                                                            ...
                                                            border:
                                                                Border.all(color: themeChange.getThem() ? AppColors.darkContainerBorder : AppColors.containerBorder, width: 0.5),
                      ...
                      ButtonThem.buildButton(
                        ...
                        onPress: () async {
                          ...
                          if (controller.selectedPaymentMethod.value == controller.paymentModel.value.strip!.name) {
                            ...
                            RazorPayController()
                                .createOrderRazorPay(amount: controller.calculateAmount().toInt(), razorpayModel: controller.paymentModel.value.razorpay)
                                .then((value) {
                              if (value == null) {
                                Get.back();
